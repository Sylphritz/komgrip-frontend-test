import type { AssetsResponse } from '@/api/coincap/types'

export const MOCK_ASSETS_RESPONSE: AssetsResponse = {
  data: [
    {
      id: 'bitcoin',
      rank: '1',
  ...
  timestamp: 1697564926566
}

export const MOCK_EMPTY_ASSETS_RESPONSE: AssetsResponse = {
  data: [],
  timestamp: 1697564926566
}
